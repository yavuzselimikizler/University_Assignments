...
public class Account{
    ...
    protected ArrayList<Account> blocked_accounts;
...
//Account class constructure
    public Account( int user_id, String user_name, String location, String birth_date){
        ...
        blocked_accounts= new ArrayList<Account>();
...
//logout  account
    ...
    public void addMessage(Message message,ArrayList<Account>  account_list){
