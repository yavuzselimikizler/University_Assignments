...
public class Account{
    ...
    protected LinkedList<Post>  myPosts ;
    ...
    protected LinkedList<Account> blocked_accounts;
...
//Account class constructure
    public Account( int user_id, String user_name, String location, String birth_date){
        ...
        blocked_accounts= new LinkedList<Account>();
...
//logout  account
    ...
    public void unfollowing(Account unfollow){
        ...
        for(int i=0;i<following.size();i++){
            ...
            if(unfollow.get_id()==following.get(i).get_id() && unfollow.get_username()==following.get(i).get_username()){
    ...
    public void addMessage(Message message,LinkedList<Account>  account_list){
        ...
        if(isOnline!=true){
            ...
            for(int i=0;i<viewed.blocked_accounts.size();i++){
                ...
                if(viewed.blocked_accounts.get(i).get_id()==this.get_id() && viewed.blocked_accounts.get(i).get_username()==this.get_username()){
                    ...
                    System.out.println("the account: "+ this.get_username()+ "blocked you you can not view his/her profile.");
                    return;
                }
            }
            ...
            if(post_interaction.get_id()!=current_viewing_id.get_id()){ 
                ...
                for(int i=0;i<post_interaction.myPosts.size();i++){
                    ...
                    if (post_interaction.myPosts.get(i).get_likes()==0){
                       ...
                       post_interaction.myPosts.get(i).print_likers(); // print the accounts liked the post.
                       System.out.println("");
                    }
    
                    if(post_interaction.myPosts.get(i).get_content_num()==0){
